<template>
	...
	<div class="pilot-modal pilot-identity" style="color:white!important">
		...
		<div class="body">
			<div class="add-padding"> Union Administrative RM-4 Pilot Identification Protocol (IDENT) Record {{ pilot.id }} </div>
						...
						<div class="row flex-container-cols">
							<div class="col col-primary">
								<span class="flavor-text">
									...
									Name (or legal alias): <b class="accent--text">{{ pilot.name }}</b><br>
									Background: <b class="accent--text"> {{ pilot.background }} </b>
								</span>
							</div>
							<div class="col">CALLSIGN AVAILABLE <br> IDENTITY VERIFIED <br> PH/HR DATA REGISTERED</div>
						</div>
						<div style="padding-top:5px">FRAME CONFIGURATION OPTIONS
							...
							<div class="col" style="padding-top:5px">
								...
								<div class="chip-container" v-for="license in pilot.licenses" :key="license.id">
									<span class="chip">
										...
										{{ getLicense(license.id, license.rank) }}
									</span>
								</div>
							</div>
						</div>
						<div class="row biometrics-container">
							<div class="biometrics">
								<i aria-hidden="true"
									...
									style="font-size: 36px; margin-top:1em;"></i>
								BIOMETRIC RECORD VALID [[{{ randomNumber(14, 22) }}PB]] :: OHM C//{{ timeStamp(pilot.lastModified) }}
							</div>
						</div>
					</div>
					<div class="col">
